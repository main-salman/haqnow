...
const InteractiveWorldMap: React.FC<InteractiveWorldMapProps> = ({
  ...
  // Helper function to get country name from code (bilingual: English and native)
  const getCountryName = (code: string): string => {
    const countryNames: Record<string, { english: string; native: string }> = {
      'AF': { english: 'Afghanistan', native: 'افغانستان' },
      'BD': { english: 'Bangladesh', native: 'বাংলাদেশ' }, 
      'KY': { english: 'Cayman Islands', native: 'Cayman Islands' },
      'CA': { english: 'Canada', native: 'Canada' },
      'US': { english: 'United States', native: 'United States' },
      'FR': { english: 'France', native: 'France' },
      'GB': { english: 'United Kingdom', native: 'United Kingdom' },
      'DE': { english: 'Germany', native: 'Deutschland' },
      'IT': { english: 'Italy', native: 'Italia' },
      'ES': { english: 'Spain', native: 'España' },
      'NL': { english: 'Netherlands', native: 'Nederland' },
      'BE': { english: 'Belgium', native: 'België / Belgique' },
      'CH': { english: 'Switzerland', native: 'Schweiz / Suisse' },
      'AT': { english: 'Austria', native: 'Österreich' },
      'SE': { english: 'Sweden', native: 'Sverige' },
      'NO': { english: 'Norway', native: 'Norge' },
      'DK': { english: 'Denmark', native: 'Danmark' },
      'FI': { english: 'Finland', native: 'Suomi' },
      'PL': { english: 'Poland', native: 'Polska' },
      'CZ': { english: 'Czech Republic', native: 'Česká republika' },
      'SK': { english: 'Slovakia', native: 'Slovensko' },
      'HU': { english: 'Hungary', native: 'Magyarország' },
      'RO': { english: 'Romania', native: 'România' },
      'BG': { english: 'Bulgaria', native: 'България' },
      'GR': { english: 'Greece', native: 'Ελλάδα' },
      'PT': { english: 'Portugal', native: 'Portugal' },
      'IE': { english: 'Ireland', native: 'Éire' },
      'RU': { english: 'Russia', native: 'Россия' },
      'CN': { english: 'China', native: '中国' },
      'JP': { english: 'Japan', native: '日本' },
      'KR': { english: 'South Korea', native: '대한민국' },
      'IN': { english: 'India', native: 'भारत' },
      'PK': { english: 'Pakistan', native: 'پاکستان' },
      'ID': { english: 'Indonesia', native: 'Indonesia' },
      'MY': { english: 'Malaysia', native: 'Malaysia' },
      'TH': { english: 'Thailand', native: 'ประเทศไทย' },
      'VN': { english: 'Vietnam', native: 'Việt Nam' },
      'PH': { english: 'Philippines', native: 'Pilipinas' },
      'SG': { english: 'Singapore', native: 'Singapore' },
      'AU': { english: 'Australia', native: 'Australia' },
      'NZ': { english: 'New Zealand', native: 'New Zealand' },
      'ZA': { english: 'South Africa', native: 'South Africa' },
      'EG': { english: 'Egypt', native: 'مصر' },
      'NG': { english: 'Nigeria', native: 'Nigeria' },
      'KE': { english: 'Kenya', native: 'Kenya' },
      'MA': { english: 'Morocco', native: 'المغرب' },
      'DZ': { english: 'Algeria', native: 'الجزائر' },
      'TN': { english: 'Tunisia', native: 'تونس' },
      'LY': { english: 'Libya', native: 'ليبيا' },
      'BR': { english: 'Brazil', native: 'Brasil' },
      'MX': { english: 'Mexico', native: 'México' },
      'AR': { english: 'Argentina', native: 'Argentina' },
      'CL': { english: 'Chile', native: 'Chile' },
      'PE': { english: 'Peru', native: 'Perú' },
      'CO': { english: 'Colombia', native: 'Colombia' },
      'VE': { english: 'Venezuela', native: 'Venezuela' },
      'UY': { english: 'Uruguay', native: 'Uruguay' },
      'PY': { english: 'Paraguay', native: 'Paraguay' },
      'BO': { english: 'Bolivia', native: 'Bolivia' },
      'EC': { english: 'Ecuador', native: 'Ecuador' },
      'GY': { english: 'Guyana', native: 'Guyana' },
      'SR': { english: 'Suriname', native: 'Suriname' },
      'GF': { english: 'French Guiana', native: 'Guyane française' },
      'TR': { english: 'Turkey', native: 'Türkiye' },
      'IR': { english: 'Iran', native: 'ایران' },
      'IQ': { english: 'Iraq', native: 'العراق' },
      'SY': { english: 'Syria', native: 'سوريا' },
      'LB': { english: 'Lebanon', native: 'لبنان' },
      'JO': { english: 'Jordan', native: 'الأردن' },
      'IL': { english: 'Israel', native: 'ישראל' },
      'PS': { english: 'Palestine', native: 'فلسطين' },
      'SA': { english: 'Saudi Arabia', native: 'المملكة العربية السعودية' },
      'AE': { english: 'UAE', native: 'الإمارات العربية المتحدة' },
      'QA': { english: 'Qatar', native: 'قطر' },
      'KW': { english: 'Kuwait', native: 'الكويت' },
      'BH': { english: 'Bahrain', native: 'البحرين' },
      'OM': { english: 'Oman', native: 'عُمان' },
      'YE': { english: 'Yemen', native: 'اليمن' }
    };
    
    const country = countryNames[code];
    if (country) {
      // Show both English and native names if they're different
      return country.english === country.native 
        ? country.english 
        : `${country.english} / ${country.native}`;
    }
    return code;
  };
