...
def login_with_2fa():
    """Login with email/password and handle 2FA"""
    print("🔐 Admin Login for Disclaimer Translation Population")
    print("=" * 50)
    
    # Get credentials
    email = input("Enter admin email: ").strip()
    if not email:
        email = "salman.naqvi@gmail.com"  # Default
    ...
    if data.get('requires_2fa'):
        ...
        # Get 2FA token from user
        twofa_token = input("Enter your 6-digit 2FA code: ").strip()
...
def populate_disclaimer_translations():
    ...
    print("🚀 Disclaimer Translations Population with 2FA Support")
    print("=" * 60)
    ...
    # Load disclaimer translations from JSON file
    disclaimer_translations = {
        ...
        "disclaimer.privacyCommitmentText": "HaqNow.com provides complete anonymity for document uploads:",
        ...
        "disclaimer.faqA1": "Yes, if you follow our security guidelines. HaqNow.com is designed with complete anonymity in mind - we don't store IP addresses, require registration, or log user activity. However, your own security practices are crucial.",
        "disclaimer.faqQ2": "Can my government track me if I upload documents?",
        "disclaimer.faqA2": "HaqNow.com cannot be used to identify you, but governments may monitor internet traffic. In high-risk countries, consider using VPN and Tor browser for additional protection. Never use work or government computers.",
    ...
    print(f"📝 Found {len(disclaimer_translations)} disclaimer translations to upload")
    ...
    print("📡 Uploading translations to server...")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("\n🎉 SUCCESS! You can now:")
            print("   1. Visit https://www.haqnow.com/admin-translations-page")
            print("   2. Select 'Disclaimer' section to see all translations")
            print("   3. Visit https://www.haqnow.com/disclaimer to see the populated page")
            print("   4. Add custom FAQs using customFaqQ_XXXXX and customFaqA_XXXXX keys")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("🔗 Admin Translations: https://www.haqnow.com/admin-translations-page")
        print("🔗 Disclaimer Page: https://www.haqnow.com/disclaimer")
    else:
